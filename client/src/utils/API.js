...
export default {
  getQuote: function(a,b,c,d,e) {
  	...
  	const promise6 = axios.get(stockfinancials1)
  	const promise7 = axios.get(stockfinancials2)
  	const promise8 = axios.get(stockfinancials3)
  	const promise9 = axios.get(stockfinancials4)
  	const promise10 = axios.get(stockfinancials5)
